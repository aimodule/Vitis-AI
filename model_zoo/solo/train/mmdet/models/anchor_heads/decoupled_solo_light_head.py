...
class DecoupledSOLOLightHead(nn.Module):
    ...
    def forward_single(self, x, idx, eval=False, upsampled_size=None):
        ...
        if eval:
            ins_pred_x = F.interpolate(ins_pred_x.sigmoid(), size=upsampled_size, mode='nearest')
            ins_pred_y = F.interpolate(ins_pred_y.sigmoid(), size=upsampled_size, mode='nearest')
